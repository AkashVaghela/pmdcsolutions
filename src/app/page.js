                ...
                <div className="content py-4">
                  ...
                  <div className="description">
                    <p style={{ maxWidth: "44rem", margin: "0 auto" }}>
                      PMDC crafts web, mobile, and e-commerce solutions that not only look great but perform flawlessly. Our digital experiences are designed to attract visitors, build trust, and convert them into loyal customers — helping businesses of all sizes stay ahead in today’s fast-paced online world.
                    </p>
                  </div>
