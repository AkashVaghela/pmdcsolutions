                ...
                <div className="service-header" data-aos="fade-up">
                  ...
                  <div className="service-tabs" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div className="tab-content">
                      <div className={`tab-pane fade ${activeTab === 'overview' ? 'show active' : ''}`} id="tab-overview" role="tabpanel"><div className="row"><div className="col-md-6"><div className="content-block"><h3>Strategy to Delivery</h3><p>Customer discovery, market fit, and clear prioritization frameworks.</p><p>Roadmaps that balance impact, risk, and speed across teams.</p></div></div><div className="col-md-6"><img src="/assets/img/services/services-4.webp" alt="Product Management" className="img-fluid rounded" /></div></div></div>
                      ...
                      <div className={`tab-pane fade ${activeTab === 'tools' ? 'show active' : ''}`} id="tab-tools" role="tabpanel">
                        <div className="row g-4">
                          <div className="col-md-6"><div className="content-block"><h3>Product & Discovery</h3><ul><li>Jira, Linear, Notion</li><li>OKRs, Roadmaps, RICE</li><li>User research, JTBD, A/B testing</li></ul></div></div>
                          <div className="col-md-6"><div className="content-block"><h3>Analytics & Delivery</h3><ul><li>GA4, Mixpanel, Amplitude</li><li>Looker/Metabase dashboards</li><li>Agile, Scrum, Release management</li></ul></div></div>
                        </div>
                      </div>
                    </div>
                  </div>
