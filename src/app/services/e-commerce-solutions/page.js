              ...
              <div className="col-lg-8 order-lg-1 order-2">
                <div className="service-main-content">
                  <div className="service-header" data-aos="fade-up">
                    ...
                    <p className="lead">We build blazing-fast storefronts with secure checkout, robust catalog management, and integrations for inventory, tax, and shipping.</p>
                  </div>
                  <div className="service-tabs" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div className="tab-content">
                      <div className={`tab-pane fade ${activeTab === 'overview' ? 'show active' : ''}`} id="tab-overview" role="tabpanel"><div className="row"><div className="col-md-6"><div className="content-block"><h3>Headless & Monolithic</h3><p>Shopify/Shopify Plus, WooCommerce, or headless with Next.js based on your needs.</p><p>Payments, fraud, and tax services integrated.</p></div></div><div className="col-md-6"><img src="/assets/img/services/services-2.webp" alt="Ecommerce" className="img-fluid rounded" /></div></div></div>
