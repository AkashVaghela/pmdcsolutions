                    ...
                    <div className="tab-content">
                      ...
                      <div className={`tab-pane fade ${activeTab === 'tools' ? 'show active' : ''}`} id="tab-tools" role="tabpanel">
                        <div className="row g-4">
                          <div className="col-md-6"><div className="content-block"><h3>Platforms</h3><ul><li>Shopify/Plus, WooCommerce</li><li>Headless: Next.js, Commerce APIs</li><li>PIM, OMS integrations</li></ul></div></div>
                          <div className="col-md-6"><div className="content-block"><h3>Checkout & Ops</h3><ul><li>Stripe, Adyen, PayPal</li><li>TaxJar/Avalara, Shippo/ShipStation</li><li>SEO, CRO, Analytics (GA4)</li></ul></div></div>
                        </div>
                      </div>
                    </div>
                  </div>
